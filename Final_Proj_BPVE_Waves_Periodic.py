...
#2D wavepacket, Periodic Boundary in x and in y
...
#y. To the constant streamfunction/geopotential field we generatea random
#perturbation in the form of 2-D wave packets
